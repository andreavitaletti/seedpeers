...
const siteConfigRaw = {
  ...
  hero: {
    ...
    description:
      'I semi sono archivi viventi di biodiversità, ma il cambiamento climatico, la perdita di habitat e l’uso non sostenibile del territorio stanno spingendo molte specie vegetali verso l’estinzione. <b>SeedPeers è una rete no-profit peer-to-peer di micro-serre collocate in ambienti indoor </b> come case, scuole e spazi comuni, <b>dove coltiviamo e preserviamo semi di specie vegetali incluse nella <a href="https://www.iucnredlist.org/"><u>Lista Rossa delle Specie Minacciate dell’IUCN</u></a>, insieme ad altre specie localmente minacciate e sottoutilizzate.</b> Il nostro obiettivo è trasformare i cittadini in  agenti attivi della conservazione della biodiversità, attraverso l’apprendimento e la pratica della coltivazione delle piante, della propagazione e della conservazione dei semi. \n<b>Insieme coltiviamo il futuro.</b > ',
  ...
  locales: {
    en: {
      ...
      hero: {
        ...
        description:
          'Seeds are living repositories of biodiversity, yet climate change, habitat loss, and unsustainable land use are driving many plant species toward extinction. <b>SeedPeers is a non-profit peer-to-peer network of micro-greenhouses deployed in indoor environments</b> such as homes, schools, and community buildings, <b>where we cultivate and preserve seeds of plant species included in the <a href="https://www.iucnredlist.org/"> <u>IUCN Red List of Threatened Species </u></a>, together with other locally threatened and underutilized species.</b> Our aim is to turn citizens into active agents of biodiversity conservation by learning and practicing plant cultivation, propagation, and seed conservation.\n<b>Together we cultivate the future.</b>',
